...
9. **Doğrudan Uygulama Kuralı (Kullanıcı Kuralı):** Bir istek veya düzeltmede teknik engel, yan etki veya konuşulması gereken açık bir husus yoksa tekrar "uygulayayım mı?" diye sormadan doğrudan uygulanır, test edilir ve raporlanır.
